// Hero Section Component for PawnRace Chess Academy
// Main landing page hero with engaging visuals and call-to-action
...
// Hero section with compelling messaging and visual elements
