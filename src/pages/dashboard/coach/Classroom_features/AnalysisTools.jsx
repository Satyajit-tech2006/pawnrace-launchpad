...
import { RotateCcw, Repeat, Trash2, PenTool, Eye, EyeOff, MousePointer2 } from 'lucide-react';

const AnalysisTools = ({ 
    onReset, onFlip, onClear, 
        ...
        {showTools && (
            <div className="flex items-center justify-center gap-6 bg-[#1a1a1a] border border-white/5 rounded-xl p-3 shadow-2xl w-full animate-in slide-in-from-bottom-2 fade-in duration-300">
                ...
                <div className="flex items-center gap-2 pl-2">
                    ...
                    {/* Visual Indicator: Draw is Active */}
                    ...
                    {/* Visual Indicator: Mark is Active */}
