...
// REUSE COMPONENTS from Coach Folder (Efficient!)
...
const StudentVideoClassroom = () => {
    ...
    const [orientation, setOrientation] = useState('black'); // Students usually play Black?
    ...
    // --- UI State ---
    const [activeTab, setActiveTab] = useState('chat'); // Default to Chat for students
    ...
    function onDrop(sourceSquare, targetSquare) {
        // Allow student to move? usually yes in interactive lessons
    ...
    const handleSendMessage = (text) => {
        ...
        const messageData = { text, time, sender: 'Student' };
    ...
    const handleDownloadPGN = () => {
        ...
        a.href = url; a.download = `class_game.pgn`; document.body.appendChild(a); a.click(); document.body.removeChild(a);
    };
        ...
        <div className="h-screen bg-[#111] text-white flex flex-col overflow-hidden font-sans">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="flex-1 bg-[#0a0a0a] relative flex flex-col justify-center items-center">
                    ...
                    <div className="relative shadow-2xl shadow-black/50" style={{ width: boardWidth, height: boardWidth }}>
                        <Chessboard 
                            ...
                            showBoardNotation={false} // Using custom overlay
                            
                            // Student can draw arrows locally for themselves, but they won't sync to coach yet
                    ...
                    <div className="mt-6 flex justify-center">
                        <button 
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-[#1a1a1a] hover:bg-[#252525] border border-white/5 rounded-full text-xs font-bold uppercase tracking-wider transition-all"
                        >
                ...
                <ClassroomSidebar 
                    ...
                    // Disable PGN loading for student (read-only mostly)
