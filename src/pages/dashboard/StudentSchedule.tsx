  ...
  const upcomingClasses = [
    {
      ...
      description: 'Focus on controlling the center and developing pieces efficiently'
    },
    {
      id: 2,
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {upcomingClasses.map((lesson) => (
              <div key={lesson.id} className="border border-border rounded-lg p-6 hover-lift bg-card">
